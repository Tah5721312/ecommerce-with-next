...
.wrapper .container .three .content .piece:nth-child(3) {
  ...
  animation-delay: 4.5s;
    ...
    {/* about */}
    <div className="about">
      <a href="https://webdeasy.de/en/html-css-404-page-templates/"className="bg_links social portfolio" target="_blank" rel="noopener noreferrer" >
        <span className="icon" />
      </a>
      <a href="https://dribbble.com/rafaelalucas"className="bg_links social dribbble" target="_blank" rel="noopener noreferrer" >
        <span className="icon" />
      </a>
      <a href="https://dribbble.com/rafaelalucas"className="bg_links social linkedin" target="_blank" rel="noopener noreferrer" >
      <span className="icon" />
      </a>
      <button  className="bg_links logo" />
    </div>
    <nav>
      <div className="menu">
        <p className="website_name">LOGO</p>
        <div className="menu_links">
          <a href="https://webdeasy.de/en/html-css-404-page-templates/"className="link" target="_blank" rel="noopener noreferrer" >
            about
          </a>
          <a href="https://webdeasy.de/en/html-css-404-page-templates/"className="link" target="_blank" rel="noopener noreferrer" >
            projects
      ...
      <div className="container">
        ...
        <div className="text">
          <article>
            ...
            <Link  href="/"> <button>i dare!</button>  </Link>
          </article>
        </div>
      </div>
    </section>
